...
def collectStatistics( filename="sbm1.mat", method="coin_toss" ):
	...
	Original.Adjacency = adjacency2
	Original.Labels = Original.Labels[:Original.getAdjacency().shape[0],:]
	labels = np.zeros((883, 4))
	Original.Labels = np.append(Original.Labels, labels, axis=0)
	#Original.k_core(2)
